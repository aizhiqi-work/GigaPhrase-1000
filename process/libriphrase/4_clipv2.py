...
# 输出目录
OUT_DIR = "/nvme01/openkws/libriphrase/segments/LP-460"
...
if __name__ == "__main__":
    parquet_file = "/nvme01/openkws/libriphrase/counts/ls-460/matched_sentences.parquet"
    ...
    df_grouped["audio_path"] = df_grouped["audio_path"].apply(lambda x: x.replace(OUT_DIR, "LP-460"))
    df_grouped["ori_audio_path"] = df_grouped["ori_audio_path"].apply(lambda x: x.replace("/nvme01/openkws/libriphrase/audio", "LP-460"))

    # 保存 parquet
    out_parquet = "/nvme01/openkws/libriphrase/counts/ls-460/segments_by_ngram_list.parquet"
