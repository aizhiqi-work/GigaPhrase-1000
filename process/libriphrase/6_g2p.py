...
# 加载 Parquet 文件
parquet_file = "/nvme01/openkws/libriphrase/counts/ls-460/78k/aggregated_segments_by_ngram.parquet"
...
out_parquet = "/nvme01/openkws/libriphrase/counts/ls-460/78k/aggregated_segments_with_g2p.parquet"
