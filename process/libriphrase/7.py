...
# 加载数据集
parquet_file = "/nvme01/openkws/libriphrase/counts/ls-460/78k/aggregated_segments_with_g2p.parquet"
...
# 保存 parquet
out_parquet = "/nvme01/openkws/libriphrase/counts/ls-460/78k/aggregated_segments_with_g2p_distance.parquet"
